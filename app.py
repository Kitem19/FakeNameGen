...
# Mostra indirizzo email con icona copia accanto
email_address = f"{username}@{domain}"
st.markdown(f"<b>Email:</b> <code>{email_address}</code> <button onClick=\"navigator.clipboard.writeText('{email_address}')\">📋</button>", unsafe_allow_html=True)


# --- Pulsante aggiorna messaggi ---

# Pulsante per aggiornare i messaggi ogni 10s per max 2 minuti
